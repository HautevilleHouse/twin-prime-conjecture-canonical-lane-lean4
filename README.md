# Twin Prime Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/twin-prime-conjecture-canonical-lane-mathlib.git
cd twin-prime-conjecture-canonical-lane-mathlib
lake exe
lake build
```
